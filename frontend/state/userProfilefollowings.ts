...
const userProfilefollowingsSlice = createSlice({
  name: "userProfilefollowings",
  initialState,
  reducers: {
...
export const { addPosts, increaseSkip, resetFeed } = userProfilefollowingsSlice.actions;
export default userProfilefollowingsSlice.reducer;
